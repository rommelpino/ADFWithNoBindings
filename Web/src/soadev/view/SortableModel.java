...
public class SortableModel extends CollectionModel {
        ...
        try {
            ...
            try {
                ...
                Object propertyValue =
                    evaluateProperty(resolver, data, property);
    ...
    private Object evaluateProperty(PropertyResolver resolver, Object base,
                                    String property) {
        ...
        return evaluateProperty(resolver, newBase,
    ...
    public void setSortCriteria(List<SortCriterion> criteria) {
        if ((criteria == null) || (criteria.isEmpty())) {
            ...
            if ((_sortCriterion == null) || (!_sortCriterion.equals(sc))) {
                _sortCriterion = sc;
                _sort(_sortCriterion.getProperty(),
                      _sortCriterion.isAscending());
            }
        }
    }
    ...
    private int _toRowIndex(Object rowKey) {
        ...
        try {
            ...
            _LOG.warning("INVALID_ROWKEY",
                         new Object[] { rowKey, rowKey.getClass() });
            _LOG.warning(e);
            return -1;
        }
    }
